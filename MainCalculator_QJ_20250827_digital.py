...
from src.Config_QJ_20250827_digital import config_row_data_20250827_qj_digital
from src.Config_QJ_20250827_digital import PreModel_QJ_20250827_digital
...
def main_cal(_, path2, path3):
    ...
    df_input = config_input_20250827_qj_digital()
    ...
    # 获取表头
    head_list = config_headlist_20250827_qj_digital()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20250827_qj_digital(df_input_row, para, data)
        ...
        md = PreModel_QJ_20250827_digital(parameter=para)
