...
from src.Config_QJ_20241218_qinghezhan import config_input_20241218_qinghezhan
from src.Config_QJ_20241218_qinghezhan import config_headlist_20241218_qinghezhan
from src.Config_QJ_20241218_qinghezhan import config_row_data_20241218_qinghezhan
from src.Config_QJ_20241218_qinghezhan import PreModel_20241218_QJ_qinghezhan
...
def main_cal(_, path2, path3):
    ...
    df_input = config_input_20241218_qinghezhan()
    ...
    # 获取表头
    head_list = config_headlist_20241218_qinghezhan()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20241218_qinghezhan(df_input_row, para, data)
        ...
        md = PreModel_20241218_QJ_qinghezhan(parameter=para)
...
if __name__ == '__main__':
    sub_name = '20241218_清河站'
    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())
    main_cal(None,
             '%s\\仿真输出_清河站邻线干扰_%s.xlsx' % (sub_name, timestamp),
             os.getcwd())
