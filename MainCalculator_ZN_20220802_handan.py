...
from src.Config_ZN_20220802_handan import config_headlist_handan
from src.Config_ZN_20220802_handan import PreModel_0802_handan
...
def main_cal(path1, path2, path3):
    ...
    para['发送内阻_0802_handan'] = ImpedanceMultiFreq()
    para['发送内阻_0802_handan'].z = {
        1700: 4.4,
        2000: 4.4,
        2300: 4.4,
        2600: 4.4}

    para['zs_EL_BE1-600/25_handan'] = ImpedanceMultiFreq()
    para['zs_EL_BE1-600/25_handan'].rlc_s = {
        1700: (0.34970, 0.16877e-3, None),
        2000: (0.37434, 0.16740e-3, None),
        2300: (0.39914, 0.16622e-3, None),
        2600: (0.42405, 0.16519e-3, None)}

    para['zm_EL_BE1-600/25_handan'] = ImpedanceMultiFreq()
    para['zm_EL_BE1-600/25_handan'].rlc_s = {
        1700: (50.658, 0.011402, None),
        2000: (59.820, 0.010734, None),
        2300: (68.064, 0.010160, None),
        2600: (76.083, 0.009665, None)}

    para['n_EL_BE1-600/25_handan'] = {
        1700: 3,
        2000: 3,
        2300: 3,
        2600: 3}
    ...
    para['z1_handan'] = ImpedanceMultiFreq()
    para['z1_handan'].rlc_s = {
        1700: (None, 5e-3, 20e-6),
        2000: (None, 5e-3, 20e-6),
        2300: (None, 5e-3, 20e-6),
        2600: (None, 5e-3, 20e-6)}

    para['调整电阻_handan'] = ImpedanceMultiFreq()
    para['调整电阻_handan'].z = {
        1700: 100,
        2000: 100,
        2300: 100,
    ...
    head_list = config_headlist_handan()
    ...
    clist2 = clist3 = clist4 = clist5 = clist6 = [[]]
    # clist1 = list(range(50, 1300, 50))
    clist1 = [268]
    ...
    for cv1, cv2, cv3, cv4, cv5, cv6 in clist:
        ...
        row_data.config_sec_name('-', '304/322G', pd_read_flag=flag)

        row_data.config_sec_length(1345, 507, pd_read_flag=flag)
        row_data.config_offset(-239, pd_read_flag=flag)
        # row_data.config_offset(-239, pd_read_flag=True)

        row_data.config_mutual_coeff(26.2, pd_read_flag=flag)
        row_data.config_freq(2600, 1700, pd_read_flag=flag)
        # row_data.config_freq(cv1, cv2, pd_read_flag=flag)
        row_data.config_c_num(20, 0, pd_read_flag=flag)
        ...
        row_data.config_c_value(40, 25, pd_read_flag=flag)
        ...
        row_data.config_sr_mode('左发', '左发', pd_read_flag=False)
        ...
        row_data.config_cable_length(10, 2, pd_read_flag=flag, respectively=True)
        ...
        row_data.config_power(2, '最大', pd_read_flag=False)
        ...
        md = PreModel_0802_handan(parameter=para)
