...
from src.Config_QJ_20240408_double_line import config_input_20240408_double_line
from src.Config_QJ_20240408_double_line import config_headlist_20240408_double_line
from src.Config_QJ_20240408_double_line import config_row_data_20240408_double_line
from src.Config_QJ_20240408_double_line import PreModel_QJ_20240408_double_line
...
def main_cal(_, path2, path3, list_type, list_length, list_freq):
    ...
    df_input = config_input_20240408_double_line(list_type, list_length, list_freq)
    ...
    # 获取表头
    head_list = config_headlist_20240408_double_line()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20240408_double_line(df_input_row, para, data)
        ...
        md = PreModel_QJ_20240408_double_line(parameter=para)
...
def cycle_cal():
    ...
    dir_path = '%s\\仿真输出_区间复线不同频遍历_%s' % (sub_name, timestamp)
    ...
    for val_type in list_type:
        for val_length in list_length:
            for val_freq in list_freq:
                ...
                file_name = '区间复线_%s对%s_%sm_主串%sHz_被串%sHz.xlsx' % values_tmp
