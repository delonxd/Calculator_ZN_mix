...
from src.Config_QJ_20231103_xinggongxian import config_input_20231103_xinggongxian
from src.Config_QJ_20231103_xinggongxian import config_headlist_20231103_xinggongxian
from src.Config_QJ_20231103_xinggongxian import config_row_data_20231103_xinggongxian
from src.Config_QJ_20231103_xinggongxian import PreModel_20231103_QJ_xinggongxian
...
def main_cal(_, path2, path3):
    ...
    df_input = config_input_20231103_xinggongxian()
    ...
    # 获取表头
    head_list = config_headlist_20231103_xinggongxian()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20231103_xinggongxian(df_input_row, para, data)
        ...
        md = PreModel_20231103_QJ_xinggongxian(parameter=para)
        ...
        for posi_bei in posi_list:
            ...
            MainLog.add_log_accurate('分路位置 --> %sm' % posi_bei)
    ...
    data2excel["被串钢轨电流"].header[0] = 'X1LQAG机械绝缘节'
    data2excel["被串分路电流"].header[0] = 'X1LQAG机械绝缘节'
...
if __name__ == '__main__':
    sub_name = '20231103_邢贡线'
    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())
    main_cal(None,
             '%s\\仿真输出_邢贡线邻线干扰_%s.xlsx' % (sub_name, timestamp),
             os.getcwd())
