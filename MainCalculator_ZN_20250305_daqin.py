...
def main_cal(path1, path2, window):
    ...
    for calc_type in calc_types:
        ...
        df_input = regular_input_20240305_daqin(df_input, calc_type)
        ...
        for temp_temp in range(num_len):
            ...
            row_data.config_c_value(50, 50, pd_read_flag=flag)
...
def main_test():
    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())
    path1 = '20250304_大秦线站内改造\\模拟区段.xlsx'
    path2 = '20250304_大秦线站内改造\\仿真输出_%s.xlsx' % timestamp
