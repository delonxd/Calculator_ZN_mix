...
from src.Config_ZN_20260813_pusu_LKJ import config_input_20260813_pusu_lkj
from src.Config_ZN_20260813_pusu_LKJ import config_headlist_20260813_pusu_lkj
from src.Config_ZN_20260813_pusu_LKJ import config_row_data_20260813_pusu_lkj
from src.Config_ZN_20260813_pusu_LKJ import PreModel_20260813_ZN_pusu_lkj
...
def main_cal(input_path, output_path, work_path):
    ...
    df_input = config_input_20260813_pusu_lkj()

    writer = pd.ExcelWriter(input_path, engine='xlsxwriter')
    workbook = writer.book
    header_format = workbook.add_format(excel_format_table)
    ...
    # 获取表头
    head_list = config_headlist_20260813_pusu_lkj()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20260813_pusu_lkj(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_20260813_ZN_pusu_lkj(parameter=para)
...
if __name__ == '__main__':
    # file = '20250724_25Hz电码化邻线干扰'
    # name = '20250724_25Hz电码化邻线干扰'
    
    file = '20260813_普速列控'
    name = '20260813_普速列控'
    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())

    path1 = f'{file}\\参数输入_{name}_{timestamp}.xlsx'
    path2 = f'{file}\\仿真输出_{name}_{timestamp}.xlsx'
    path3 = os.getcwd()
