...
# 配置邢贡线参数 Config_QJ_20231103_xinggongxian.py

# 配置输入
def config_input_20231103_xinggongxian():
...
# 配置表头
def config_headlist_20231103_xinggongxian():
    head_list = [
        '序号',
        '备注',
        '分路模式',
...
# 配置行数据
def config_row_data_20231103_xinggongxian(df_input, para, data):
    # 序号
    ...
    data['分路终点'] = offset + 900


class PreModel_20231103_QJ_xinggongxian(PreModel):
