...
def config_input_20260422_25hz_coding():
...
# 配置表头
def config_headlist_20260422_25hz_coding():
    head_list = [
        '序号',
        '备注',
        # '线路名称', '车站名称',
...
# 配置行数据
def config_row_data_20260422_25hz_coding(df_input, para, data):
    # 序号
...
class PreModel_20260422_ZN_25hz_coding(PreModel):
