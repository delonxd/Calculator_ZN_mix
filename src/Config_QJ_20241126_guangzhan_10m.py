...
# 配置输入
def config_input_20241126_guangzhan_10m():
...
# 配置表头
def config_headlist_20241126_guangzhan_10m():
    head_list = [
        '序号',
        '备注',
        '分路模式',
...
def config_c_pack_20241126_guangzhan_10m(src):
    c_num_list = []
    c_imp_list = []
    c_val_list = []
...
# 配置行数据
def config_row_data_20241126_guangzhan_10m(df_input, para, data):
    # 序号
    ...
    # 电容配置
    c_pack_zhu = config_c_pack_20241126_guangzhan_10m([df_input['主串电容数']])
    c_pack_bei = config_c_pack_20241126_guangzhan_10m(df_input['被串电容数'])
...
class PreModel_QJ_20241126_guangzhan_10m(PreModel):
