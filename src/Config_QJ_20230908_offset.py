...
# 配置输入
def config_input_20230908_offset():
...
# 配置表头
def config_headlist_20230908_offset():
    head_list = [
        '序号',
        # '备注',
        # '线路名称', '车站名称',
...
def config_c_pack_20230908_offset(freq_list, length_list, c_value_src):
...
# 配置行数据
def config_row_data_20230908_offset(df_input, para, data):
    # 序号
...
class PreModel_20230908_QJ_offset(PreModel):
