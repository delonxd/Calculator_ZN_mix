...
def config_input_20250724_25hz_coding():
    ...
    sec_list = [
        ['IVG1', 780, 2600, 8, '左发', 80, 300, 0, 60],
        ['37DG', 161, 2600, 0, '左发', 80, 300, -49, 60],
    ]
...
# 配置表头
def config_headlist_20250724_25hz_coding():
    head_list = [
        '序号',
        '备注',
        # '线路名称', '车站名称',
...
# 配置行数据
def config_row_data_20250724_25hz_coding(df_input, para, data):
    # 序号
...
class PreModel_2024120250724_ZN_25hz_coding(PreModel):
    ...
    def add_train(self):
        ...
        l3 = Line(name_base='线路3', sec_group=self.section_group3,
                  parameter=self.parameter, train=[self.train0, self.train2])
        self.l3 = l3
