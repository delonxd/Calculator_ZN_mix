...
def config_input_20250818_25hz_coding():
    ...
    sec_list = [
        ['IG', 861, 2600, 9, '左发', 80, 100, 0, 60],
        ['IG', 861, 2300, 9, '右发', 80, 100, 0, 60],
        ['IIG', 1119, 2600, 12, '左发', 80, 100, -125, 60],
        ['IIG', 1119, 2300, 12, '右发', 80, 100, -125, 60],
    ]
...
# 配置表头
def config_headlist_20250818_25hz_coding():
    head_list = [
        '序号',
        '备注',
        # '线路名称', '车站名称',
...
# 配置行数据
def config_row_data_20250818_25hz_coding(df_input, para, data):
    # 序号
...
class PreModel_20250818_ZN_25hz_coding(PreModel):
