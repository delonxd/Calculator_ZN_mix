...
from src.Config_ZN_20250724_25Hz_coding import config_row_data_20250724_25hz_coding
from src.Config_ZN_20250724_25Hz_coding import PreModel_2024120250724_ZN_25hz_coding
...
def main_cal(output_path, work_path):
    ...
    df_input = config_input_20250724_25hz_coding()
    ...
    # 获取表头
    head_list = config_headlist_20250724_25hz_coding()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20250724_25hz_coding(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_2024120250724_ZN_25hz_coding(parameter=para)
        ...
        for posi_bei in posi_list:
            ...
            md.train0.posi_rlt = data['占车位置(m)']
            md.train0.set_posi_abs(0)
