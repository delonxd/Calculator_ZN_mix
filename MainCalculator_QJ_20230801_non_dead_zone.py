...
from src.Config_QJ_20230801_non_dead_zone import config_input_20230801_non_dead_zone
from src.Config_QJ_20230801_non_dead_zone import config_headlist_20230801_non_dead_zone
from src.Config_QJ_20230801_non_dead_zone import config_row_data_20230801_non_dead_zone
from src.Config_QJ_20230801_non_dead_zone import PreModel_20230801_non_dead_zone
...
def main_cal(_, output_path, work_path):
    ...
    # head_list = config_headlist_20230522_qingrongxian()
    # head_list = config_headlist_20230720_pusu()
    head_list = config_headlist_20230801_non_dead_zone()
    ...
    for temp_temp in range(num_len):
        ...
        # config_row_data_20230522_qingrongxian(df_input_row, para, data)
        # config_row_data_20230720_pusu(df_input_row, para, data)
        config_row_data_20230801_non_dead_zone(df_input_row, para, data)
        ...
        # md = PreModel_20230720_pusu(parameter=para)
        md = PreModel_20230801_non_dead_zone(parameter=para)
        ...
        for posi_bei in posi_list:
            ...
            data2excel.add_data(sheet_name="主串本区段轨入电压", data1=v_rcv_zhu1)
            data2excel.add_data(sheet_name="主串邻区段轨入电压", data1=v_rcv_zhu2)
