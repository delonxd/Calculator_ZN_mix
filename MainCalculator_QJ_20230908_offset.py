...
from src.Config_QJ_20230908_offset import config_input_20230908_offset
from src.Config_QJ_20230908_offset import config_headlist_20230908_offset
from src.Config_QJ_20230908_offset import config_row_data_20230908_offset
from src.Config_QJ_20230908_offset import PreModel_20230908_QJ_offset
...
def main_cal(_, path2, path3):
    ...
    df_input = config_input_20230908_offset()
    ...
    # 获取表头
    head_list = config_headlist_20230908_offset()
    ...
    for temp_temp in range(num_len):
        ...
        config_row_data_20230908_offset(df_input_row, para, data)
        ...
        md = PreModel_20230908_QJ_offset(parameter=para)
...
if __name__ == '__main__':
    sub_name = '20230908_区间错位遍历'
    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())
    main_cal(None,
             '%s\\仿真输出_区间错位遍历_%s.xlsx' % (sub_name, timestamp),
             os.getcwd())
