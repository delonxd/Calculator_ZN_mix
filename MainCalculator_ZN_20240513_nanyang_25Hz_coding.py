...
from src.Config_ZN_20240513_nanyang import config_input_20240513_nanyang_25hz_coding
from src.Config_ZN_20240513_nanyang import config_headlist
from src.Config_ZN_20240513_nanyang import config_row_data
from src.Config_ZN_20240513_nanyang import PreModel_20240513_ZN_nanyang_25Hz_coding
...
def main_cal(_, output_path, work_path):
    ...
    df_input = config_input_20240513_nanyang_25hz_coding()
    ...
    for temp_temp in range(num_len):
        ...
        # 分路计算
        md = PreModel_20240513_ZN_nanyang_25Hz_coding(parameter=para)
...
if __name__ == '__main__':
    sub0 = '20240513_南阳疏解线25Hz电码化\\'
    sub1 = '南阳疏解线邻线干扰'

    timestamp = time.strftime("%Y%m%d%H%M%S", time.localtime())

    path1 = ''
    path2 = '%s仿真输出_%s_%s.xlsx' % (sub0, sub1, timestamp)
    path3 = os.getcwd()
