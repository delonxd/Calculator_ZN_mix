...
from src.Config_ZN_20250818_25Hz_coding import config_input_20250818_25hz_coding
from src.Config_ZN_20250818_25Hz_coding import config_headlist_20250818_25hz_coding
from src.Config_ZN_20250818_25Hz_coding import config_row_data_20250818_25hz_coding
from src.Config_ZN_20250818_25Hz_coding import PreModel_20250818_ZN_25hz_coding
...
def main_cal(output_path, work_path):
    ...
    df_input = config_input_20250818_25hz_coding()
    ...
    # 获取表头
    head_list = config_headlist_20250818_25hz_coding()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20250818_25hz_coding(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_20250818_ZN_25hz_coding(parameter=para)
...
if __name__ == '__main__':
    ...
    file = '20250818_25Hz电码化'
    name = '20250818_25Hz电码化'
