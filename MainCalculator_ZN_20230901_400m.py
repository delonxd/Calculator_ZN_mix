...
from src.Config_ZN_20230901_400m import config_input_20230901_400m
from src.Config_ZN_20230901_400m import config_headlist
from src.Config_ZN_20230901_400m import config_row_data
from src.Config_ZN_20230901_400m import PreModel_20230901_ZN_400m
...
def main_cal(input_path, output_path, work_path, freq_zhu, freq_bei):
    ...
    df_input = config_input_20230901_400m(freq_zhu, freq_bei)
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_20230901_ZN_400m(parameter=para)
...
if __name__ == '__main__':
    ...
    for val in freq_list:
        ...
        path1 = '邻线干扰参数输入_20230901_站内400m遍历.xlsx'
        path2 = '%s仿真输出_%s_%s_主串%s_被串%s.xlsx' % (sub0, timestamp, sub1, f1, f2)
        path3 = os.getcwd()

        main_cal(path1, path2, path3, f1, f2)
