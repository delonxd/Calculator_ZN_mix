...
from src.Config_ZN_20240618_dalong_digital import config_input_20240618_dalong_digital
from src.Config_ZN_20240618_dalong_digital import config_headlist
from src.Config_ZN_20240618_dalong_digital import config_row_data
from src.Config_ZN_20240618_dalong_digital import PreModel_20240618_ZN_Dalong_Digital
...
def main_cal(_, output_path, work_path):
    ...
    df_input = config_input_20240618_dalong_digital()
    ...
    for temp_temp in range(num_len):
        ...
        # 分路计算
        md = PreModel_20240618_ZN_Dalong_Digital(parameter=para)
