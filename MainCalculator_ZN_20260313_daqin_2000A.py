...
from src.Config_ZN_20260313_daqin2000A import config_input_20260313_daqin_2000a
from src.Config_ZN_20260313_daqin2000A import config_headlist_20260313_daqin_2000a
from src.Config_ZN_20260313_daqin2000A import config_row_data_20260313_daqin_2000a
from src.Config_ZN_20260313_daqin2000A import PreModel_20260313_ZN_daqin_2000a
...
def main_cal(output_path, work_path):
    ...
    # 参数输入
    df_input = config_input_20260313_daqin_2000a()
    ...
    # 获取表头
    head_list = config_headlist_20260313_daqin_2000a()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20260313_daqin_2000a(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_20260313_ZN_daqin_2000a(parameter=para)
    ...
    # data2excel["被串钢轨电流"].header[0] = '被串接收端'
    # data2excel["被串分路电流"].header[0] = '被串接收端'
    # data2excel["主串钢轨电流"].header[0] = '被串接收端'
...
if __name__ == '__main__':
    ...
    path1 = '20260313_大秦站内2000A\\仿真输出_大秦站内邻线干扰_%s.xlsx' % timestamp
    path2 = os.getcwd()
