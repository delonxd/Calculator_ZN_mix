...
def main_cal(input_path, output_path, work_path):
    ...
    df_input = config_input_20241220_xiayuanzhan()
    ...
    # 获取表头
    head_list = config_headlist_20241220_xiayuanzhan()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20241220_xiayuanzhan(df_input_row, para, data)
        ...
        # 分路计算
        md = PreModel_20241220_ZN_xiayuanzhan(parameter=para)
        ...
        for posi_bei in posi_list:
            ...
            md.train0.posi_rlt = data['分路起点'] + 50
