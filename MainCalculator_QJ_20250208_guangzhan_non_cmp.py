...
def main_cal(_, path2, path3):
    ...
    # 参数输入
    df_input = config_input_20250208_guangzhan_non_cmp()
    ...
    # 获取表头
    head_list = config_headlist_20250208_guangzhan_non_cmp()
    ...
    for temp_temp in range(num_len):
        ...
        # 配置数据
        config_row_data_20250208_guangzhan_non_cmp(df_input_row, para, data)
        ...
        md = PreModel_QJ_20250208_guangzhan_non_cmp(parameter=para)
